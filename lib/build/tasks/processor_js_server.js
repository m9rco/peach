...
module.exports = function ($, appConf, moduleConf, args) {
  return function (mod, modulePath, appPath) {
    return new Promise(function (resolve, reject) {
      ...
      vfs.src([path.join(modulePath, 'dist', '_static', '{page,widget,static}', '**', '*.js'), path.join('!' + modulePath, 'dist', '_static', '{page,widget}', '**', '*.min.js')])
        .pipe(peachMate.processorJS({
        ...
        .pipe($.if(jsProcessorConf.type === 'nerv', through2.obj(function (file, enc, cb) {
